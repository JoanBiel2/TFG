...
{strg > 2:
    ~GiveExp(25)
    ~GiveEvidence("Llave de Delgado","Llave","Una llave")
    Lo levantas con esfuerzo. Debajo del cuerpo no encuentras nada relevante, solo más sangre en el suelo. #Speaker: Narrador #Portrait: narrador_anim
- else:
